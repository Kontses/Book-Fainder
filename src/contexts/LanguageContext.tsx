...
const translations: Translations = {
  ...
  el: {
    ...
    feedbackFeature: "Πρόταση Λειτουργίας",
    feedbackContent: "Θέμα Περιεχομένου",
    feedbackCooperation: "Επαγγελματική Συνεργασία",
    fastSearchTitle: "Γρήγορη Αναζήτηση",
    fastSearchDesc: "Βρίσκει γρήγορα σχετικά βιβλία και επιλέγει ένα τυχαία. Παρακάμπτει τη βαθιά ανάλυση AI για ταχύτητα.",
    deepSearchTitle: "Έξυπνη Αναζήτηση",
    deepSearchDesc: "Χρησιμοποιεί προηγμένη AI για να αναλύσει όλα τα αποτελέσματα και να επιλέξει το απόλυτα καλύτερο για εσάς. Πιο αργή αλλά πιο ακριβής.",

    feedbackMessage: "Μήνυμα",
    feedbackPlaceholder: "Πείτε μας τη γνώμη σας...",
    sendFeedback: "Αποστολή",
    sending: "Αποστολή...",
    feedbackSentSuccess: "Τα σχόλια στάλθηκαν επιτυχώς!",
    feedbackError: "Αποτυχία αποστολής σχολίων",
    feedbackPrompt: "Θα θέλαμε τη γνώμη σας!",
    feedbackPromptDesc: "Κάνατε 10 αναζητήσεις! Πείτε μας τη γνώμη σας στο προφίλ σας.",
    giveFeedback: "Πείτε τη γνώμη σας",
    // Random prompts
    randomPrompts: [
